...
class JMethodDeclaration extends JAST implements JMember {
    ...
    protected  ArrayList<TypeName> qualifiedIdentifiers;
    ...
    public JMethodDeclaration(int line, ArrayList<String> mods, String name, Type returnType,
                              ArrayList<JFormalParameter> params, JBlock body, ArrayList<TypeName> qualifiedIdentifiers) {
        super(line);
        this.mods = mods;
        this.name = name;
    ...
    public void toJSON(JSONElement json) {
        ...
        if(qualifiedIdentifiers != null){
            ArrayList<String> value = new ArrayList<String>();
            for (TypeName q : qualifiedIdentifiers) {
                value.add("\""+q.toString()+"\"");
            }
