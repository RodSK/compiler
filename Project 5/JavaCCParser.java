...
{if ("" != null) return new JClassDeclaration(line, mods, name, superClass, classBody, implementz);}
    throw new Error("Missing return statement in function");
}
...
name = token.image;
      ...
      case EXTENDS:{
        jj_consume_token(EXTENDS);
        superClassONE = qualifiedIdentifier();
superClass.add(superClassONE);
        label_6:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case COMMA:{
...
{if ("" != null) return new JInterfaceDeclaration(line, mods, name, superClass, interfaceBody);}
    throw new Error("Missing return statement in function");
}
  ...
  final private ArrayList<JMember> interfaceBody() throws ParseException {ArrayList<String> mods = null;
    ...
    try {
      ...
      while (true) {
        ...
        mods = modifiers();
        membersONE = interfaceMemberDecl(mods);
members.add(membersONE);
      }
      jj_consume_token(RCURLY);
    } catch (ParseException e) {
recoverFromError(new int[] { SEMI, EOF }, e);
...
{if ("" != null) return members;}
  ...
  final private JMember memberDecl(ArrayList<String> mods) throws ParseException {int line = 0;
    ...
    ArrayList<TypeName> qualifiedIdentifiers = new ArrayList<TypeName>();
    TypeName qualifiedIdentifiersONE = null;
    try {
...
line = token.beginLine;
        ...
        case THROWS:{
          ...
          qualifiedIdentifiersONE = qualifiedIdentifier();
qualifiedIdentifiers.add(qualifiedIdentifiersONE);
          label_9:
          while (true) {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case COMMA:{
...
qualifiedIdentifiers.add(qualifiedIdentifiersONE);
        ...
        body = block();
memberDecl = new JConstructorDeclaration(line, mods, name, params, body, qualifiedIdentifiers);
...
memberDecl = new JMethodDeclaration(line, mods, name, type, params, body, qualifiedIdentifiers);
      } else {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case BOOLEAN:
        case CHAR:
...
qualifiedIdentifiers.add(qualifiedIdentifiersONE);
        ...
        jj_consume_token(SEMI);
interfaceMemberDecl = new JMethodDeclaration(line, mods, name, type, params, null, qualifiedIdentifiers);
      } else {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case BOOLEAN:
        case CHAR:
...
{if ("" != null) return statement;}
  ...
  final private JStatement statement() throws ParseException {int line = 0;
    ...
    ArrayList<JSwitchStatement> switchBlockStatementGroup = new ArrayList<JSwitchStatement>();
    JSwitchStatement groupONE = null;
    ArrayList<JStatement> forInit = new ArrayList<JStatement>();
    ArrayList<JStatement> forUpdate = new ArrayList<JStatement>();
    ArrayList<JFormalParameter> formPar = new ArrayList<JFormalParameter>();
    JFormalParameter formParONE = null;
    JBlock tryBlock = null;
    ArrayList<JBlock> catchBlock = new ArrayList<JBlock>();
    JBlock catchBlockONE = null;
...
statement = new JForStatement(line, forInit, expr, forUpdate, consequent);
        break;
        }
      case IF:{
        jj_consume_token(IF);
...
line = token.beginLine;
        ...
        while (true) {
          ...
          groupONE = switchBlockStatementGroup();
switchBlockStatementGroup.add(groupONE);
        }
        jj_consume_token(RCURLY);
statement = new JSwitchStatement(line, test, switchBlockStatementGroup, null, null, false)
        ;
        break;
        }
      case TRY:{
...
line = token.beginLine;
        ...
        while (true) {
          ...
          jj_consume_token(LPAREN);
          formParONE = formalParameter();
formPar.add(formParONE);
          jj_consume_token(RPAREN);
          catchBlockONE = block();
catchBlock.add(catchBlockONE);
        }
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case FINALLY:{
...
statement = new JTryStatement(line, tryBlock, formPar, catchBlock, finalBlock);
        break;
        }
      case THROW:{
...
{if ("" != null) return statement;}
  ...
  final private ArrayList<JStatement> forUpdate() throws ParseException {ArrayList<JStatement> updates = new ArrayList<JStatement>();
    JStatement updatesONE = null;
    try {
      updatesONE = statementExpression();
updates.add(updatesONE);
      label_15:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case COMMA:{
...
{if ("" != null) return updates;}
  ...
  final private ArrayList<JStatement> forInit(int lineV) throws ParseException {int line = lineV;
    Type type = null;
    ArrayList<JStatement> inits = new ArrayList<JStatement>();
    JStatement initsONE = null;
...
{if ("" != null) return new JFormalParameter(line, name, type);}
  ...
  final private JSwitchStatement switchBlockStatementGroup() throws ParseException {int line    = 0;
    ...
    JExpression switchLabelONE = null;
    JStatement blockStatementONE = null;
    try {
      switchLabelONE = switchLabel();
line = token.beginLine;
        switchLabels.add(switchLabelONE);
      label_18:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case CASE:
...
switchLabels.add(switchLabelONE);
      ...
      while (true) {
        ...
        blockStatementONE = blockStatement();
blockStatements.add(blockStatementONE);
      }
    } catch (ParseException e) {
recoverFromError(new int[] { SEMI, EOF }, e);
    }
{if ("" != null) return new JSwitchStatement(line, null, null, switchLabels, blockStatements, true);}
    throw new Error("Missing return statement in function");
}
  ...
  private boolean jj_3R_135()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x0,0x10041000,0x10040000,0x1000,0x1000,0x1000000,0x0,0x8000000,0x0,0x1000000,0x20223000,0x20223000,0x0,0x0,0x20222000,0x0,0x0,0x0,0x20222000,0x20222000,0x0,0x0,0x20222000,0xe43a6000,0xc4184000,0x60222000,0x40000000,0x40000000,0x408000,0x10000,0x2000000,0x40000000,0xc4184000,0x0,0x0,0x60222000,0x0,0x20222000,0x408000,0xe43a6000,0x408000,0x0,0x0,0x40000000,0x0,0x40000000,0x0,0x40000000,0x20222000,0x20222000,0x0,0x0,0x20222000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x0,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x20222000,0x0,0x0,0x0,0x40000000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x20,0x1,0x5c0,0x0,0x5c0,0x5c0,0x0,0x100000,0x0,0x100000,0x0,0x405c4,0x405c4,0x100000,0x8000,0x40004,0x100000,0x8000,0x10800000,0x4,0x40004,0x100000,0x8000,0x4,0x118b7a1c,0x118b7a18,0x101281c,0x1012818,0x1012818,0x0,0x0,0x0,0x1012818,0x118b7a18,0x100000,0x100000,0x101281c,0x100000,0x4,0x0,0x118b7a1c,0x0,0x100000,0x0,0x1812818,0x100000,0x1812818,0x100000,0x1012818,0x4,0x4,0x400000,0x400000,0x4,0x40000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x2,0x2,0x20000000,0x20000000,0x0,0x0,0x0,0x0,0x1012818,0x0,0x1012818,0x600000,0x0,0x0,0x1000000,0x600000,0x1000000,0x1000000,0x1200000,0x1000000,0x1012818,0x4,0x800000,0x1000000,0x400000,0x10010,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2290820,0x2290820,0x2290820,0x2290820,0x2290820,0x0,0x0,0x0,0x2290820,0x2290820,0x0,0x0,0x2290820,0x0,0x0,0x0,0x2290820,0x0,0x0,0x8,0x2290820,0x0,0x2290820,0x0,0x2290820,0x0,0x0,0x0,0x0,0x0,0x9514008d,0x9514008d,0x20000000,0x8000,0x1000,0x800000,0x0,0x0,0x400100,0x400100,0x6600,0x6600,0x20002,0x20002,0x2080000,0x2080000,0x48000040,0x48000040,0x2290820,0x210000,0x0,0x0,0x820,0x820,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0xe64,0xe64,0xe64,0xe64,0xe64,0x0,0x0,0x0,0xe64,0xe64,0x0,0x0,0xe64,0x0,0x4,0x0,0xe64,0x0,0x0,0x0,0xe64,0x0,0xe64,0x0,0xe64,0x0,0x0,0x0,0x0,0x4,0x2,0x2,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe64,0x0,0xe64,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe64,0x4,0x0,0x0,0x0,0xe60,};
	}
